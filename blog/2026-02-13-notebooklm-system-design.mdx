...
pub async fn extract_entities(
    ...
    let prompt = format!(
        r#"Extract all named entities from the following text.
        Return JSON array with format: [{{"name": "...", "type": "Person|Organization|Concept", "description": "..."}}]
...
```cypher
// EdgeQuake Cypher 查询示例
// 问题: "谁和 Elon Musk 有关系，并且在这个笔记本中被提到？"
