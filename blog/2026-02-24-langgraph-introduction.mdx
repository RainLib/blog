...
- **1. 多 Agent 协同 (Multi-agent Collaboration)**
  - 🔗 [教程：Multi-agent Collaboration](https://github.com/langchain-ai/langgraph/blob/main/docs/docs/tutorials/multi_agent/multi-agent-collaboration.ipynb)
- **2. 计划和执行 (Plan and Execute)**
  - 🔗 [教程：Plan and Execute](https://github.com/langchain-ai/langgraph/blob/main/docs/docs/tutorials/plan-and-execute/plan-and-execute.ipynb)
- **3. 自适应 RAG (Adaptive RAG)**
  - 🔗 [教程：Adaptive RAG](https://github.com/langchain-ai/langgraph/blob/main/docs/docs/tutorials/rag/langgraph_adaptive_rag.ipynb)
- **4. 自我反思与 Reflexion**
  - 🔗 [教程：Reflection](https://github.com/langchain-ai/langgraph/blob/main/docs/docs/tutorials/reflection/reflection.ipynb)
  - 🔗 [教程：Reflexion](https://github.com/langchain-ai/langgraph/blob/main/docs/docs/tutorials/reflexion/reflexion.ipynb)
- **5. 思维树 (ToT) 与 ReWOO**
  - 🔗 [教程：Tree of Thoughts (ToT)](https://github.com/langchain-ai/langgraph/blob/main/docs/docs/tutorials/tot/tot.ipynb)
  - 🔗 [教程：ReWOO](https://github.com/langchain-ai/langgraph/blob/main/docs/docs/tutorials/rewoo/rewoo.ipynb)
- **6. 并行调度器 (LLMCompiler)**
  - 🔗 [教程：LLMCompiler](https://github.com/langchain-ai/langgraph/blob/main/docs/docs/tutorials/llm-compiler/LLMCompiler.ipynb)
